...
class ModifiedResNet(nn.Module):
    ...
    def __init__(self, layers, output_dim, heads, input_resolution=224, width=64):
        ...
        self.relu = nn.ReLU(inplace=True)
        self.global_avgpool = nn.AvgPool2d(2 , stride=2)
        ...
        self.attnpool = AttentionPool2d(input_resolution // 64, embed_dim, heads, output_dim)
...
def build_model(state_dict: dict, args):
    ...
    if image_resolution != args.crop_size:
        image_resolution = args.crop_size
