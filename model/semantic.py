...
class semantic(nn.Module):
    ...
    def forward(self,img_feature_map, word_features, num_classes=80):
        ...
        f_wd_feature = self.fc_2(word_features).view(1, self.num_classes, self.intermediary_dim).repeat(batch_size * convsize * convsize, 1, 1)
        ...
        sd_features = torch.sum(torch.sum(img_feature_map, 1), 1)
        return sd_features
